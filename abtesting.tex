...
\section{Methods}
A simple A/B test consists of the control group and the variant, which are exposed to different set of users from the pool of all users, not unlike early clinical trials.
...
Like selecting a treatment for scurvy, finding a working game design may be more definitive when driven by data. Uncertainty comes from the many caveats ahead for those driven by data from controlled experiments.
